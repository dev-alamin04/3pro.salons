...
<head>
    ...
    <meta name="author" content="al_amin , al_amin, , al_amin-, al_amin_, MD al_amin ">
...
<body class="flex items-center justify-center w-screen h-screen text-center">
    <div class="Box">
        <h1 class="text-6xl font-bold text-white">Welcome to Admin</h1>
